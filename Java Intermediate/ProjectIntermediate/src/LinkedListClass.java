...
public class LinkedListClass {
    public static void main(String[] args) {
        ...
        LinkedList<Double> list = new LinkedList<Double>();//có các thuộc tính file App.java
        list.add(2.02);
        list.add(2.01d);
        ...
        list.addFirst((double) 4);//Java chặt ở chỗ, ta thêm int vào hàm nhận double nó éo cho mà phải tự cast
        list.addLast(6d);
        list.addLast(6d);
        System.out.println("\n" + list.getFirst());
        ...
        System.out.println(arr.length);//phân biệt class dùng .size(); còn array dùng .length;
