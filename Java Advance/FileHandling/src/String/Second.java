...
public class Second {
    public static void main(String[] args) {
        ...
        System.out.println(array.equals(array1));//kp so sánh giống nhau hay k mà là so sánh 2 biến có cùng tham chiếu
        //đến 1 đối tượng k
        // Nhưng khi dùng với tring sẽ ngược lại: str.equals(str2); sẽ compare giá trị 2 biến. Còn str==str2 sẽ compare 
        //tham chiếu vùng nhớ 2 biến giống k nên dùng giá trị giống mà k cùng vùng nhớ cx sai
