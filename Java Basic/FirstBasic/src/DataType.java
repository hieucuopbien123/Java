...
public class DataType {
    ...
    public static void main(String[] args) {
        ...
        int i = 100;    
        float f = i;    // chuyển từ kiểu dữ liệu long lên kiểu float
        ...
        System.out.println("Gia tri bien d = " + decimalFormat.format(d));//ít hơn số lượng # ở phần thập phân thì 
        //sẽ in bình thường format k ảnh hưởng
    }
}
